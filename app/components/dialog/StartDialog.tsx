        ...
        <div className="max-h-full overflow-y-auto space-y-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col items-center gap-4">
              <p>
                RiskGuard is your newest open-source agentic AI platform powered by
              ...
              {invalidSettings ? (
                ...
                <p>
                  ...
                  You can start by adding existing data to RiskGuard via the
                  Weaviate console. RiskGuard will analyze your data and create an
